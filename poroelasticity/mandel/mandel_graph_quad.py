...
# ==============================================================================
f = h5py.File('./output/step00_quad-poroelastic.h5','r')
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_x_raw_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_z_0_raw_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_x_0_raw_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_z_raw_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_z_0_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_x_0_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_x_quad.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_z_quad.png',dpi = 300)
