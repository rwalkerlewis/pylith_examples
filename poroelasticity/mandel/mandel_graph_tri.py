...
# ==============================================================================
f = h5py.File('./output/step00_tri-poroelastic.h5','r')
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_x_raw_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_z_0_raw_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_x_0_raw_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_z_raw_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_z_0_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_pressure_x_0_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_x_tri.png',dpi = 300)
...
fig.tight_layout()
fig.savefig('output/mandel_displacement_z_tri.png',dpi = 300)
