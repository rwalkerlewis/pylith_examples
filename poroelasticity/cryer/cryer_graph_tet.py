...
# ==============================================================================
f = h5py.File('./output/step00_tet-poroelastic.h5','r')
...
fig.tight_layout()
fig.savefig('output/cryer_pressure_along_x_axis_norm_tet.png',dpi = 300)
fig.show()
...
fig.tight_layout()
fig.savefig('output/cryer_radial_displacement_along_x_axis_norm_tet.png',dpi = 300)
fig.show()
...
fig.tight_layout()
fig.savefig('output/cryer_radial_displacement_along_z_axis_norm_tet.png',dpi = 300)
fig.show()
...
fig.tight_layout()
fig.savefig('output/cryer_radial_displacement_along_z_axis_tet.png',dpi = 300)
fig.show()
...
fig.tight_layout()
fig.savefig('output/cryer_displacement_along_x_axis_tet.png',dpi = 300)
fig.show()
...
fig.tight_layout()
fig.savefig('output/cryer_displacement_along_y_axis_tet.png',dpi = 300)
fig.show()
...
fig.tight_layout()
fig.savefig('output/cryer_displacement_along_z_axis_tet.png',dpi = 300)
fig.show()
